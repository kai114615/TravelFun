...
(function ($)
{
  function init(plot) // this is the "body" of the plugin
  {
    ...
    function calcTotal(data)
    {
      ...
      {
        const item = Number.parseFloat(data[i].data[0][1])
        if (item)
          total += item;
      }
    }
    ...
    function combine(data)
    {
      ...
      for (let i = 0; i < data.length; ++i)
      {
        ...
        data[i].data[0][1] = Number.parseFloat(data[i].data[0][1]);
        if (!data[i].data[0][1])
          data[i].data[0][1] = 0;
      ...
      function drawPie()
      {
        ...
        function drawLabels()
        {
          ...
          function drawLabel(slice, startAngle, index)
          {
            ...
            // format label text
            const lf = options.legend.labelFormatter; let text; const plf = options.series.pie.label.formatter
            if (lf)
    ...
    function triggerClickHoverEvent(eventname, e)
    {
      ...
      const canvasX = Number.parseInt(e.pageX - offset.left);
      const canvasY = Number.parseInt(e.pageY - offset.top);
