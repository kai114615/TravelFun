  ...
  $.extend($.fn.dataTableExt.oPagination, {
    bootstrap: {
      ...
      fnUpdate(oSettings, fnDraw) {
        ...
        let i; let ien; let j; let sClass; let iStart; let iEnd; const iHalf = Math.floor(iListLength / 2);
          ...
          for (j = iStart; j <= iEnd; j++) {
            ...
            $(`<li ${sClass}><a href="#">${j}</a></li>`)
              ...
              .bind('click', function (e) {
                e.preventDefault()
                oSettings._iDisplayStart = (Number.parseInt($('a', this).text(), 10) - 1) * oPaging.iLength
                fnDraw(oSettings)
              });
          }
