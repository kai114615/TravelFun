...
(function (mod) {
  ...
  CodeMirror.defineMode('scheme', () => {
    const BUILTIN = 'builtin'; const COMMENT = 'comment'; const STRING = 'string'
    const ATOM = 'atom'; const NUMBER = 'number'; const BRACKET = 'bracket';
          ...
          default: // default parsing mode
            ...
            if (ch == '"') {
              ...
              if (stream.eat('|')) { // Multi-line comment
                ...
                let numTest = null; let hasExactness = false; let hasRadix = true
                if (stream.eat(/[ei]/i)) {
                  hasExactness = true
                } else {
