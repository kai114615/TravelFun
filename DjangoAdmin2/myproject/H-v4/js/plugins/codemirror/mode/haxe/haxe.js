...
(function (mod) {
  ...
  CodeMirror.defineMode('haxe', (config, parserConfig) => {
    ...
    const keywords = (function () {
      ...
      const operator = kw('operator'); const atom = { type: 'atom', style: 'atom' }; const attribute = { type: 'attribute', style: 'attribute' }
    ...
    function haxeTokenBase(stream, state) {
      ...
      if (ch == '"' || ch == '\'') {
        ...
        {
          stream.eatWhile(/\w/);
          var word = stream.current(); const known = keywords.propertyIsEnumerable(word) && keywords[word]
    ...
    return {
      ...
      indent (state, textAfter) {
        ...
        const firstChar = textAfter && textAfter.charAt(0); let lexical = state.lexical
