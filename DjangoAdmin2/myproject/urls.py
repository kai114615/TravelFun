...
urlpatterns = [
    ...
    path('theme_entertainment/', include(('theme_entertainment.urls', 'theme_entertainment'), namespace='theme_frontend')),
    path('admin-dashboard/entertainment/', include(('theme_entertainment.urls', 'theme_entertainment'), namespace='theme_admin')),
