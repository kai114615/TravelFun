(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ['jquery', 'simple-module', 'simple-hotkeys', 'simple-uploader'], ($, SimpleModule, simpleHotkeys, simpleUploader) => {
...
}(this, ($, SimpleModule, simpleHotkeys, simpleUploader) => {
  let Selection
  var __hasProp = {}.hasOwnProperty
  var __extends = function (child, parent) { for (const key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }
  ...
  Selection = (function (_super) {
    ...
    Selection.prototype.rangeAtEndOf = function (node, range) {
      let endNode, endNodeLength, result;
      if (range == null) {
        range = this.getRange();
      }
    ...
    Selection.prototype.setRangeAtEndOf = function (node, range) {
      let $lastNode, $node, contents, lastChild, lastText, nodeLength;
      if (range == null) {
        range = this.getRange();
      }
      $node = $(node);
  ...
  var __hasProp = {}.hasOwnProperty
  var __extends = function (child, parent) { for (const key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key] } function ctor () { this.constructor = child } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child };
  var __indexOf = [].indexOf || function (item) { for (let i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; }
  ...
  Formatter = (function (_super) {
    ...
    Formatter.prototype.autolink = function ($el) {
      let $node, findLinkNode, lastIndex, linkNodes, match, re, replaceEls, text, uri, _i, _len;
      if ($el == null) {
        $el = this.editor.body;
      }
      linkNodes = [];
      findLinkNode = function ($parentNode) {
        return $parentNode.contents().each((i, node) => {
          let $node, text;
          $node = $(node);
          ...
          } else if ((text = $node.text()) && /https?:\/\/|www\./i.test(text)) {
    ...
    Formatter.prototype.format = function ($el) {
      let $node, blockNode, n, node, _i, _j, _len, _len1, _ref, _ref1;
      if ($el == null) {
        $el = this.editor.body;
      }
      if ($el.is(':empty')) {
    ...
    Formatter.prototype.cleanNode = function (node, recursive) {
      let $childImg, $node, $p, $td, allowedAttributes, attr, contents, isDecoration, n, text, textNode, _i, _j, _len, _len1, _ref, _ref1;
      $node = $(node);
      if (!($node.length > 0)) {
        return
      }
  ...
  InputManager = (function (_super) {
    ...
    InputManager.prototype._init = function () {
      ...
      $(document).on(`selectionchange.simditor${this.editor.id}`, (function (_this) {
        return function (e) {
          ...
          return _this._selectionTimer = setTimeout(() => {
      ...
      this.editor.on('valuechanged', (function (_this) {
        return function () {
          ...
          _this.editor.body.find('hr, pre, .simditor-table').each((i, el) => {
            let $el, formatted;
            $el = $(el);
    ...
    InputManager.prototype._onKeyDown = function (e) {
      let $blockEl, metaKey, result, _base, _ref, _ref1;
    ...
    InputManager.prototype._onPaste = function (e) {
      let $blockEl, cleanPaste, imageFile, pasteItem, range, uploadOpt, _ref;
      if (this.editor.triggerHandler(e) === false) {
        return false;
      }
      ...
      return setTimeout((function (_this) {
        return function () {
          let $img, blob, children, insertPosition, lastLine, line, lines, node, pasteContent, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref1, _ref2, _ref3;
  ...
  Keystroke = (function (_super) {
    ...
    Keystroke.prototype._init = function () {
      ...
      this.editor.inputManager.addKeystrokeHandler('8', 'li', (function (_this) {
        return function (e, $node) {
          let $br, $childList, $newLi, $prevChildList, $prevNode, $textNode, range, text;
  ...
  UndoManager = (function (_super) {
    ...
    UndoManager.prototype._init = function () {
      ...
      return this.editor.on('valuechanged', (function (_this) {
        return function (e, src) {
          ...
          return _this._timer = setTimeout(() => {
    ...
    UndoManager.prototype._getNodeByPosition = function (position) {
      let child, childNodes, i, node, offset, _i, _len, _ref;
  ...
  Util = (function (_super) {
    ...
    Util.prototype.browser = (function () {
      let chrome, firefox, ie, safari, ua, _ref, _ref1, _ref2, _ref3;
    ...
    Util.prototype.traverseUp = function (callback, node) {
      let n, nodes, range, result, _i, _len, _results;
      if (node == null) {
        range = this.editor.selection.getRange();
        node = range != null ? range.commonAncestorContainer : void 0;
      }
    ...
    Util.prototype.indent = function () {
      let $blockEl, $childList, $nextTd, $parentLi, $td, indentLevel, range, spaceNode, tagName, _ref;
      $blockEl = this.editor.util.closestBlockEl();
    ...
    Util.prototype.outdent = function () {
      let $blockEl, $parent, $parentLi, $prevTd, $td, button, indentLevel, range, _ref;
      $blockEl = this.editor.util.closestBlockEl();
      if (!($blockEl && $blockEl.length > 0)) {
        return false;
      }
    ...
    Util.prototype.dataURLtoBlob = function (dataURL) {
      let BlobBuilder, arrayBuffer, bb, byteString, hasArrayBufferViewSupport, hasBlobConstructor, i, intArray, mimeString, _i, _ref;
      ...
      if (dataURL.split(',')[0].includes('base64')) {
      ...
      for (i = _i = 0, _ref = byteString.length; _ref >= 0 ? _i <= _ref : _i >= _ref; i = _ref >= 0 ? ++_i : --_i) {
  ...
  Toolbar = (function (_super) {
    ...
    Toolbar.prototype.toolbarStatus = function (name) {
      ...
      return this.editor.util.traverseUp((function (_this) {
        return function (node) {
          let button, i, removeButtons, _i, _j, _len, _len1;
          removeButtons = [];
  ...
  Button = (function (_super) {
    ...
    Button.prototype.renderMenu = function () {
      let $menuBtntnEl, $menuItemEl, menuItem, _i, _len, _ref, _ref1, _results;
  ...
  Popover = (function (_super) {
    ...
    Popover.prototype.refresh = function (position) {
      let editorOffset, left, targetH, targetOffset, top;
      if (position == null) {
        position = 'bottom';
      }
      if (!this.active) {
  ...
  TitleButton = (function (_super) {
    ...
    TitleButton.prototype.command = function (param) {
      let $contents, $endBlock, $startBlock, endNode, node, range, results, startNode, _i, _len, _ref;
      range = this.editor.selection.getRange();
      startNode = range.startContainer;
      endNode = range.endContainer;
      ...
      $contents.children().each((function (_this) {
        return function (i, el) {
          let c, converted, _i, _len, _results;
  ...
  ColorButton = (function (_super) {
    ...
    ColorButton.prototype.renderMenu = function () {
      ...
      this.menuWrapper.on('mousedown', '.color-list', (e) => {
        return false;
      })
  ...
  let ListButton; let OrderListButton; let UnorderListButton
  var __hasProp = {}.hasOwnProperty
  var __extends = function (child, parent) { for (const key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }
  ...
  ListButton = (function (_super) {
    ...
    ListButton.prototype.command = function (param) {
      let $contents, $endBlock, $furthestEnd, $furthestStart, $parent, $startBlock, endLevel, endNode, getListLevel, node, range, results, startLevel, startNode, _i, _len, _ref;
      range = this.editor.selection.getRange();
      startNode = range.startContainer;
      endNode = range.endContainer;
      $startBlock = this.editor.util.closestBlockEl(startNode);
    ...
    ListButton.prototype._convertEl = function (el) {
      let $el, anotherType, block, child, children, results, _i, _len, _ref;
      $el = $(el);
      results = [];
      anotherType = this.type === 'ul' ? 'ol' : 'ul';
      if ($el.is(this.type)) {
  ...
  let CodeButton; let CodePopover
  var __hasProp = {}.hasOwnProperty
  var __extends = function (child, parent) { for (const key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key] } function ctor () { this.constructor = child } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child };
  var __slice = [].slice;
  ...
  let LinkButton; let LinkPopover
  var __hasProp = {}.hasOwnProperty
  var __extends = function (child, parent) { for (const key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key] } function ctor () { this.constructor = child } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child };
  var __slice = [].slice;
  ...
  LinkButton = (function (_super) {
    ...
    LinkButton.prototype.command = function () {
      let $contents, $endBlock, $link, $newBlock, $startBlock, endNode, linkText, range, startNode, txtNode;
      range = this.editor.selection.getRange();
      if (this.active) {
  ...
  let ImageButton; let ImagePopover
  var __hasProp = {}.hasOwnProperty
  var __extends = function (child, parent) { for (const key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key] } function ctor () { this.constructor = child } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child };
  var __slice = [].slice;
  ...
  ImageButton = (function (_super) {
    ...
    ImageButton.prototype.renderMenu = function () {
      let $input, $uploadItem, createInput;
    ...
    ImageButton.prototype.loadImage = function ($img, src, callback) {
      ...
      img.onload = (function (_this) {
        return function () {
          let height, imgOffset, width, wrapperOffset;
      ...
      this.srcEl.on('keydown', (function (_this) {
        return function (e) {
          ...
          if (e.which === 13 && !_this.target.hasClass('uploading')) {
            src = _this.srcEl.val();
            if (src.startsWith('data:image') && !_this.editor.uploader) {
              hideAndFocus();
              return;
            }
            return _this.button.loadImage(_this.target, src, (success) => {
              let blob;
              if (!success) {
                return
              }
  ...
  TableButton = (function (_super) {
    ...
    TableButton.prototype._init = function () {
      ...
      this.editor.on('decorate', (function (_this) {
        return function (e, $el) {
          return $el.find('table').each((i, table) => {
    ...
    TableButton.prototype.initResize = function ($table) {
      let $colgroup, $resizeHandle, $wrapper;
      ...
      return $wrapper.on('mousedown', '.simditor-resize-handle', (function (_this) {
        return function (e) {
          let $handle, $leftCol, $leftTd, $rightCol, $rightTd, minWidth, startHandleLeft, startLeftWidth, startRightWidth, startX, tableWidth;
          ...
          startHandleLeft = Number.parseFloat($handle.css('left'));
    ...
    TableButton.prototype.renderMenu = function () {
      ...
      return this.createMenu.on('mousedown', 'td', (function (_this) {
        return function (e) {
          let $closestBlock, $table, $td, $tr, colNum, rowNum;
          _this.wrapper.removeClass('menu-on');
          if (!_this.editor.inputManager.focused) {
            return
          }
    ...
    TableButton.prototype.createTable = function (row, col, phBr) {
      let $table, $tbody, $td, $tr, c, r, _i, _j;
      $table = $('<table/>');
      $tbody = $('<tbody/>').appendTo($table);
      for (r = _i = 0; row >= 0 ? _i < row : _i > row; r = row >= 0 ? ++_i : --_i) {
        $tr = $('<tr/>').appendTo($tbody);
        for (c = _j = 0; col >= 0 ? _j < col : _j > col; c = col >= 0 ? ++_j : --_j) {
          $td = $('<td/>').appendTo($tr);
          if (phBr) {
    ...
    TableButton.prototype.insertRow = function ($td, direction) {
      let $newTr, $table, $tr, colNum, i, index, _i;
      if (direction == null) {
        direction = 'after';
      }
      $tr = $td.parent('tr');
      ...
      $newTr = $('<tr/>');
      for (i = _i = 1; colNum >= 1 ? _i <= colNum : _i >= colNum; i = colNum >= 1 ? ++_i : --_i) {
    ...
    TableButton.prototype.insertCol = function ($td, direction) {
      ...
      tableWidth = $table.width();
      width = Math.max(Number.parseFloat($col.attr('width')) / 2, 50 / tableWidth * 100);
