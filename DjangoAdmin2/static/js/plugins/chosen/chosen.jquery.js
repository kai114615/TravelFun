...
(function () {
  let $; let AbstractChosen; let Chosen; let SelectParser; let _ref
  ...
  SelectParser = (function () {
    ...
    SelectParser.prototype.escapeExpression = function (text) {
      ...
      unsafe_chars = /&(?!\w+;)|[<>"'`]/g;
      return text.replace(unsafe_chars, (chr) => {
        return map[chr] || '&amp;'
      });
    };
  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.search_string_match = function (search_string, regex) {
      ...
      if (regex.test(search_string)) {
        return true;
      } else if (this.enable_split_word_search && (search_string.includes(' ') || search_string.indexOf('[') === 0)) {
  ...
  Chosen = (function (_super) {
    ...
    Chosen.prototype.result_do_highlight = function (el) {
      ...
      if (el.length) {
        ...
        maxHeight = Number.parseInt(this.search_results.css('maxHeight'), 10);
    ...
    Chosen.prototype.choice_build = function (item) {
      ...
      if (item.disabled) {
        ...
        close_link.bind('click.chosen', (evt) => {
