...
(function ($, h, c) { let a = $([]); const e = $.resize = $.extend($.resize, {}); let i; const k = 'setTimeout'; const j = 'resize'; const d = `${j}-special-event`; const b = 'delay'; const f = 'throttleWindow'; e[b] = 250; e[f] = true; $.event.special[j] = { setup () { if (!e[f] && this[k]) { return false } const l = $(this); a = a.add(l); $.data(this, d, { w: l.width(), h: l.height() }); if (a.length === 1) { g() } }, teardown () { if (!e[f] && this[k]) { return false } const l = $(this); a = a.not(l); l.removeData(d); if (!a.length) { clearTimeout(i) } }, add (l) { if (!e[f] && this[k]) { return false } let n; function m (s, o, p) { const q = $(this); const r = $.data(this, d); r.w = o !== c ? o : q.width(); r.h = p !== c ? p : q.height(); n.apply(this, arguments) } if ($.isFunction(l)) { n = l; return m } else { n = l.handler; l.handler = m } } }; function g() { i = h[k](() => { a.each(function () { const n = $(this); const m = n.width(); const l = n.height(); const o = $.data(this, d); if (m !== o.w || l !== o.h) { n.trigger(j, [o.w = m, o.h = l]); } }); g(); }, e[b]); } })(jQuery, this);
