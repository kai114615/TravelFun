...
(function (root, factory) {
  ...
  const EasyPieChart = function (el, opts) {
    ...
    if (typeof (CanvasRenderer) !== 'undefined') {
      ...
      throw new TypeError('Please load either the SVG- or the CanvasRenderer')
    }
    ...
    const init = function () {
      ...
      if (el.dataset && el.dataset.percent) {
        this.update(Number.parseFloat(el.dataset.percent));
      } else if (el.getAttribute && el.getAttribute('data-percent')) {
        this.update(Number.parseFloat(el.getAttribute('data-percent')));
      }
    }.bind(this);
