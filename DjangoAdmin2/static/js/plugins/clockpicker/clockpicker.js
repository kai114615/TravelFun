...
;(function () {
  ...
  const svgSupported = 'SVGAngle' in window && (function () {
    let supported;
  ...
  function ClockPicker(element, options) {
    ...
    if (options.twelvehour) {
      const amPmButtonsTemplate = ['<div class="clockpicker-am-pm-block">', '<button type="button" class="btn btn-sm btn-default clockpicker-button clockpicker-am-button">', 'AM</button>', '<button type="button" class="btn btn-sm btn-default clockpicker-button clockpicker-pm-button">', 'PM</button>', '</div>'].join('')
    ...
    let i; let tick; let radian; let radius;
