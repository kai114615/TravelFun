...
(function (mod) {
  ...
  CodeMirror.defineMode('lua', (config, parserConfig) => {
    ...
    const keywords = wordRE(['and', 'break', 'elseif', 'false', 'nil', 'not', 'or', 'return', 'true', 'function', 'end', 'if', 'then', 'else', 'do', 'while', 'repeat', 'until', 'for', 'in', 'local'])
