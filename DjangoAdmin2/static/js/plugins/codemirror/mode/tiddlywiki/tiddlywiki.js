...
(function (mod) {
  ...
  // Tokenizer
    ...
    function jsTokenBase(stream, state) {
      ...
      if (/[hf]/i.test(ch)) {
        if (/[ti]/i.test(stream.peek()) && stream.match(/\b(ttps?|tp|ile):\/\/[\-\w+&@#/%?=~|$!:,.;]*[\w+&@#/%=~|$]/i)) {
      ...
      const known = textwords.propertyIsEnumerable(word) && textwords[word]
