;(function ($, window, document, undefined) {
  ...
  const pluginName = 'bootstrapDualListbox';
  const defaults = {
  ...
  const isBuggyAndroid = /android/i.test(navigator.userAgent.toLowerCase())
  ...
  function updateSelectionStates(dualListbox) {
    dualListbox.element.find('option').each((index, item) => {
      const $item = $(item)
  ...
  function refreshInfo(dualListbox) {
    ...
    const visible1 = dualListbox.elements.select1.find('option').length;
    const visible2 = dualListbox.elements.select2.find('option').length;
    const all1 = dualListbox.element.find('option').length - dualListbox.selectedElements;
    const all2 = dualListbox.selectedElements;
    let content = '';
  ...
  function filter(dualListbox, selectIndex) {
    ...
    const regex = new RegExp($.trim(dualListbox.elements[`filterInput${selectIndex}`].val()), 'gi');
    let options = dualListbox.element;
  ...
  function saveSelections(dualListbox, selectIndex) {
    dualListbox.elements[`select${selectIndex}`].find('option').each((index, item) => {
      const $item = $(item)
  ...
  function move(dualListbox) {
    ...
    dualListbox.elements.select1.find('option:selected').each((index, item) => {
      const $item = $(item)
  ...
  function remove(dualListbox) {
    ...
    dualListbox.elements.select2.find('option:selected').each((index, item) => {
      const $item = $(item)
  ...
  function bindEvents(dualListbox) {
    dualListbox.elements.form.submit((e) => {
    ...
    dualListbox.element.on('bootstrapDualListbox.refresh', (e, mustClearSelections) => {
  ...
  BootstrapDualListbox.prototype = {
    init() {
      ...
      const select1Id = `bootstrap-duallistbox-nonselected-list_${this.originalSelectName}`;
      const select2Id = `bootstrap-duallistbox-selected-list_${this.originalSelectName}`
