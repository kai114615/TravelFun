...
(function (document, window, $) {
  ...
  (function () {
    ...
    const $result = $('#examplebtTableEventsResult')

    $('#exampleTableEvents').on('all.bs.table', (e, name, args) => {
      console.log('Event:', name, ', data:', args);
    })
      .on('click-row.bs.table', (e, row, $element) => {
      ...
      .on('page-change.bs.table', (e, size, number) => {
