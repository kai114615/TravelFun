$(() => {
  ...
  const scatterChart = echarts.init(document.getElementById('echarts-scatter-chart'))
  const scatteroption = {
    title: {
      text: '男性女性身高体重分布',
  ...
  const kChart = echarts.init(document.getElementById('echarts-k-chart'))
  const koption = {
    title: {
      text: '2013年上半年上证指数'
    },
  ...
  const pieChart = echarts.init(document.getElementById('echarts-pie-chart'))
  const pieoption = {
    title: {
      text: '某站点用户访问来源',
      subtext: '纯属虚构',
  ...
  const radarChart = echarts.init(document.getElementById('echarts-radar-chart'))
  const radaroption = {
    title: {
      text: '预算 vs 开销',
      subtext: '纯属虚构'
  ...
  const mapChart = echarts.init(document.getElementById('echarts-map-chart'))
  const mapoption = {
    title: {
      text: 'iphone销量',
      subtext: '纯属虚构',
  ...
  const chordChart = echarts.init(document.getElementById('echarts-chord-chart'))
  const chordoption = {
    title: {
      text: '测试数据',
      subtext: 'From d3.js',
  ...
  const forceChart = echarts.init(document.getElementById('echarts-force-chart'))
  const forceoption = {
    title: {
      text: '人物关系：乔布斯',
      subtext: '数据来自人立方',
  ...
  const gaugeChart = echarts.init(document.getElementById('echarts-gauge-chart'))
  const gaugeoption = {
    tooltip: {
      formatter: '{a} <br/>{c} {b}'
    },
  ...
  const funnelChart = echarts.init(document.getElementById('echarts-funnel-chart'))
  const funneloption = {
    title: {
      text: '漏斗图',
      subtext: '纯属虚构'
